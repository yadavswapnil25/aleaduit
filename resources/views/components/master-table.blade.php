    ...
    $(document).ready(function() {
        ...
        const dropdownOptions = {
            ...
            'ठेवी': [
                ...
                'सभासद मासिक उत्पन्न ठेवी', 'Other'
            ],
            ...
            'तरतूद': [
                ...
                'निवडणूक खर्च तरतूद', 'सभासद कल्याण तरतूद', 'ठेव वरील व्याज तरतूद', 'कर्मचारी मानधन तरतूद',
                'ऑफिस भाडे तरतूद', 'विज बिल तरतूद', 'जी. एस. टी. तरतूद', 'Other'
            ],
            'देणे कर्ज': [
                ...
                'आय डी सी आय', 'अन्न को ऑप बँक', 'जनता को ऑप बँक', 'Other'
            ],
            'इतर देणी': [
                ...
                'जी एस टी', 'व्यवसाय कर', 'शाखा देणे', 'देय कार्यालय भाडे', 
                ...
                'कर्मचारी व्यवसाय कर', 'ठेवीवरील देय व्याज', 'Other'
            ],
            'रोख शिल्लक': [
                'धान्य दुकान रोख शिल्लक', 'रोख शिल्लक', 'शाखा क्रमांक १', 'शाखा क्रमांक २', 'Other'
            ],
            'बँक शिल्लक': [
                'बँक ऑफ बडोदा', 'बँक ऑफ इंडिया', 'बँक ऑफ महाराष्ट्र', 'केनरा बँक',
                'सेंट्रल बँक ऑफ इंडिया', 'इंडियन बँक', 'इंडियन ओव्हरसीज बँक', 'पंजाब अँड सिंध बँक',
                'पंजाब नॅशनल बँक', 'स्टेट बँक ऑफ इंडिया', 'युको बँक', 'युनियन बँक ऑफ इंडिया',
                'आय डी सी आय', 'अन्न को ऑप बँक', 'जनता को ऑप बँक', 'Other'
            ],
            'गुंतवणूक': [
                'मुदत ठेवी', 'बँक भाग हिस्से', 'राखीव निधी गुंतवणूक', 'इमारत निधी गुंतवणूक',
                ...
                'अपघात सुरक्षा निधी', 'महागुंतवणूक मुदत ठेवी', 'बँक आवर्त ठेवी',
                'बुडीत कर्ज निधी गुंतवणूक', 'घसारा निधी गुंतवणूक', 'धर्मदाय निधी गुंतवणूक',
                'लाभांश सामायिकरण निधी गुंतवणूक', 'संगणक घसारा निधी', 'शेअर्स', 
                'म्युच्युअल फंड', 'टेलिफोन डिपॉझिट', 'वीज मीटर डिपॉझिट', 'Other'
            ],
            'कायम मालमत्ता': [
                ...
                'ऑफिस फर्निचर', 'जनरेटर', 'इलेक्ट्रिक्टर', 'संचयी जागा', 'प्रिंटर',
                'सोलर पॅनल', 'लॉकर', 'सी.सी.टीव्ही कॅमेरा', 'मोबाईल', 'स्टेशनरी स्टॉक',
                'सायकल', 'इतर गाडी', 'वाचनालय साहित्य', 'Other'
            ],
            'येणे कर्ज': [
                'शुभमंगल ठेवी कर्ज', 'सोने तारण', 'वाहन तारण', 'आवर्त ठेवी तारण', 
                'दामदुप्पट ठेवी तारण', 'मुदत ठेवी तारण', 'नियमित ठेवी तारण कर्ज', 
                'आकस्मिक कर्ज', 'गृह तारण कर्ज', 'नाममात्र कर्ज', 'नियमित कर्ज', 
                'पगार तारण कर्ज', 'अल्प मुदती ठेवी तारण', 'इतर कर्ज', 'दीर्घ मुदती कर्ज', 
                'वाहन खरेदी कर्ज', 'व्यवसाय तारण कर्ज', 'घर बांधणी कर्ज', 
                'मासिक ठेवी तारण कर्ज', 'दामदुप्पट तारण कर्ज','Other'
            ],
            'इतर येणे': [
                'विद्युत बिल कर कपात', 'विमा खर्च घेणे', 'सहाय्यक निधी', 'Diwali Advanced',
                'विद्युत बिल कमिशन घेणे', 'अनामत खाते', 'टी डी एस', 'दिवाळी ऍडव्हान्स',
                'अफरातफर', 'सप्लेस', 'Other'
            ],
            'घेणे व्यज':[
                'सोनेतारण कर्ज', '१ वर्षीय मुदतठेव तारण', 'घेणे व्याज एन्डव्हान्स पगार',
                'घेणे व्याज गुंतवणुकीवरील व्याज', 'घेणे व्याज शुभमंगल ठेवी कर्ज', 
                'घेणे व्याज सोने तारण', 'घेणे व्याज वाहन तारण', 'घेणे व्याज आवर्त ठेवी तारण', 
                'घेणे व्याज दामदुप्पट ठेवी तारण', 'घेणे व्याज मुदत ठेवी तारण', 
                'घेणे व्याज नियमित ठेवी तारण कर्ज', 'घेणे व्याज आकस्मिक कर्ज', 
                'घेणे व्याज गृह तारण कर्ज', 'घेणे व्याज नाममात्र कर्ज', 
                'घेणे व्याज नियमित कर्ज', 'घेणे व्याज पगार तारण कर्ज', 
                'घेणे व्याज अल्प मुदती ठेवी तारण', 'घेणे व्याज दीर्घ मुदती कर्ज', 
                'घेणे व्याज वाहन खरेदी कर्ज', 'घेणे व्याज व्यवसाय तारण कर्ज', 
                'घेणे व्याज घर बांधणी कर्ज', 'घेणे व्याज मासिक ठेवी तारण कर्ज', 
