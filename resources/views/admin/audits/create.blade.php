                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add Audit</h3>
                        </div>
                        <form role="form" id="quickForm" method="POST" action="{{ route('admin.audits.store') }}">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="namtalika_vargwari" class="form-control @error('namtalika_vargwari') is-invalid @enderror" name="namtalika_vargwari" value="{{ old('namtalika_vargwari') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="registration_number" class="form-control @error('registration_number') is-invalid @enderror" name="registration_number" value="{{ old('registration_number') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="javak_kramank" class="form-control @error('javak_kramank') is-invalid @enderror" name="javak_kramank" value="{{ old('javak_kramank') }}">
                                            @error('javak_kramank')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
