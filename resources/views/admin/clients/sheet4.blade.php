            ...
            <form action="{{ route('admin.client.saveInputs', $client->id) }}" method="POST">
                ...
                <div>
                    ...
                    <div class="ps-3">
                        ...
                        <ol class="mb-2" style="padding-left: 20px;">
                            ...
                            <li>बाहेरिल कर्ज काढणे किंवा निधी उभारणे</li>
                            ...
                            <li>सभासदांचा आर्थीक व सामाजीक उन्नतीसाठी विविध उपक्रम हाती घेणे उपरोक्त सर्व
                                किंवा एखादा उददेश साधण्यासाठी लागणारी अनुषंगिक सर्व कामे करणे.</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        ...
                        चांगल्या प्रकारे लिहिले आहेत. त्यांना दरमहा रु. <span><input type="text" class="form-control d-inline-block" style="width:120px;display:inline;" name="mandanadhan" value="{{ isset($clientInputs['mandanadhan']) ? $clientInputs['mandanadhan'] : '' }}"></span> मानधन देण्यात येत आहे. संस्थेला
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        संस्थेचे कार्यालय <span><input type="text" class="form-control d-inline-block" style="width:120px;display:inline;" name="office_address" value="{{ $clientInputs['office_address'] ?? '' }}"></span> येथे कार्यरत आहे.
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        संस्था उपविधी क्र. 1 )3( अन्वये संस्थेचे कार्यक्षेत्र <span><input type="text" class="form-control d-inline-block" style="width:120px;display:inline;" name="work_area" value="{{ $clientInputs['work_area'] ?? '' }}"></span> पुरते मर्यादित आहे.
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        ...
                        <select class="form-control d-inline-block" style="width:80px;display:inline;" name="nominee_named">
                            <option value="">Select</option>
                            <option value="आले" {{ (isset($clientInputs['nominee_named']) && $clientInputs['nominee_named'] == 'आले') ? 'selected' : '' }}>आले</option>
                        ...
                        <select class="form-control d-inline-block" style="width:80px;display:inline;" name="share_certificates_given">
                            <option value="">Select</option>
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        संस्थेत एकूण <span><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="total_employees" value="{{ $clientInputs['total_employees'] ?? '' }}"></span> कर्मचारी आहे. सर्व कर्मचारी प्रशिक्षीत
                        <select class="form-control d-inline-block" style="width:80px;display:inline;" name="employees_trained">
                            <option value="">Select</option>
                        ...
                        . व्यवस्थापक पदावर श्री. <span><input type="text" class="form-control d-inline-block" style="width:120px;display:inline;" name="manager_name" value="{{ $clientInputs['manager_name'] ?? '' }}"></span> कार्यरत आहेत.
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        संस्थेच्या संचालक मंडळाची निवडणूक दिनांक <span style="background: #00ff00;"><input type="date" class="form-control d-inline-block" style="width:130px;display:inline;" name="election_date" value="{{ $clientInputs['election_date'] ?? '' }}"></span> ला झालेली असून अध्यक्षांची व समिती निवड दिनांक <span style="background: #00ff00;"><input type="date" class="form-control d-inline-block" style="width:130px;display:inline;" name="committee_election_date" value="{{ $clientInputs['committee_election_date'] ?? '' }}"></span> ला झाली आहे. संचालक संख्या <span><input type="text" class="form-control d-inline-block" style="width:60px;display:inline;" name="directors_count" value="{{ $clientInputs['directors_count'] ?? '' }}"></span> असून संचालक मंडळाचा कार्यकाल पाच वर्षांचा दिनांक <span style="background: #00ff00;"><input type="date" class="form-control d-inline-block" style="width:130px;display:inline;" name="term_start" value="{{ $clientInputs['term_start'] ?? '' }}"></span> ते <span style="background: #00ff00;"><input type="date" class="form-control d-inline-block" style="width:130px;display:inline;" name="term_end" value="{{ $clientInputs['term_end'] ?? '' }}"></span> पर्यंत आहे.
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        अ) आमसभा :- <br>
                        संस्थेची सन <span>01/04/{{$start}} ते 31/03/{{$end}}</span> ची आमसभा दिनांक <span style="background: yellow;"><input type="date" class="form-control d-inline-block" style="width:130px;display:inline;" name="general_meeting_date" value="{{ $clientInputs['general_meeting_date'] ?? '' }}"></span> ला संस्थेचे कार्यालय, <span><input type="text" class="form-control d-inline-block" style="width:120px;display:inline;" name="meeting_office" value="{{ $clientInputs['meeting_office'] ?? '' }}"></span> येथे संस्थेच्या अध्यक्षतेखाली घेण्यात आली असून सभेला एकूण <span><input type="text" class="form-control d-inline-block" style="width:60px;display:inline;" name="meeting_attendance" value="{{ $clientInputs['meeting_attendance'] ?? '' }}"></span> सभासद उपस्थित होते.
                        <br>
                        सभासदांमध्ये एकूण <span><input type="text" class="form-control d-inline-block" style="width:60px;display:inline;" name="tarav_ratio" value="{{ $clientInputs['tarav_ratio'] ?? '' }}"></span> ठरावर चर्चा करण्यात आली असून योग्य ते निर्णय घेण्यात आले. सर्व ठराव सभासदांनी एकमताने मंजूर दिल्याचे इतिवृत्त पुस्तकावरून दिसून येते.
                        <br>
                        ब) संचालक मंडळ सभा :-
                        <br>
                        आर्थिक वर्षात संचालक मंडळाच्या एकूण <span style="background: #00ff00;"><input type="text" class="form-control d-inline-block" style="width:60px;display:inline;" name="board_meeting_count" value="{{ $clientInputs['board_meeting_count'] ?? '' }}"></span> सभा घेण्यात आलेल्या असून संस्थेने दर महा एक सभा घेणे आवश्यक आहे. यात नवीन सभासदांना सामाविष्ट करणे, कर्जवाटप मंजूर करणे, जमाबर्च मंजूर करणे इत्यादी व इतर विषयावर चर्चा करण्यात आले आहेत
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        ...
                        <div class="mt-2">
                            ...
                            <select class="form-control d-inline-block" style="width:80px;display:inline;" name="financial_status">
                                <option value="">Select</option>
                            ...
                            <select class="form-control d-inline-block" style="width:80px;display:inline;" name="efficient_status">
                                <option value="">Select</option>
                        ...
                        <table class="table table-bordered text-center align-middle" style="min-width:700px;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="background: yellow;"><input type="text" class="form-control d-inline-block" style="width:120px;display:inline;" name="networth" value="{{ $clientInputs['networth'] ?? '10638256.99' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:120px;display:inline;" name="networth_auditor" value="{{ $clientInputs['networth_auditor'] ?? '' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:120px;display:inline;" name="networth_diff" value="{{ $clientInputs['networth_diff'] ?? '' }}"></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>भांडवल पर्याप्तता प्रमाण (CRAR)</td>
                                    <td style="background: yellow;"><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="crar" value="{{ $clientInputs['crar'] ?? '16.08' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="crar_auditor" value="{{ $clientInputs['crar_auditor'] ?? '' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="crar_diff" value="{{ $clientInputs['crar_diff'] ?? '' }}"></td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>कर्ज/ठेवी प्रमाण (CD Ratio)</td>
                                    <td style="background: yellow;"><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="cd_ratio" value="{{ $clientInputs['cd_ratio'] ?? '88.19' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="cd_ratio_auditor" value="{{ $clientInputs['cd_ratio_auditor'] ?? '' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="cd_ratio_diff" value="{{ $clientInputs['cd_ratio_diff'] ?? '' }}"></td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>थकीत कर्ज प्रमाण (%)</td>
                                    <td style="background: yellow;"><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="overdue_loan_ratio" value="{{ $clientInputs['overdue_loan_ratio'] ?? '0-00' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="overdue_loan_ratio_auditor" value="{{ $clientInputs['overdue_loan_ratio_auditor'] ?? '' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="overdue_loan_ratio_diff" value="{{ $clientInputs['overdue_loan_ratio_diff'] ?? '' }}"></td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td>ठेवळ एन. पी. ए. (%)</td>
                                    <td style="background: yellow;"><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="gross_npa" value="{{ $clientInputs['gross_npa'] ?? '61' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="gross_npa_auditor" value="{{ $clientInputs['gross_npa_auditor'] ?? '' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="gross_npa_diff" value="{{ $clientInputs['gross_npa_diff'] ?? '' }}"></td>
                                </tr>
                                <tr>
                                    <td>6</td>
                                    <td>निव्वळ एन. पी. ए. (%)</td>
                                    <td style="background: yellow;"><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="net_npa" value="{{ $clientInputs['net_npa'] ?? '61' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="net_npa_auditor" value="{{ $clientInputs['net_npa_auditor'] ?? '' }}"></td>
                                    <td><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="net_npa_diff" value="{{ $clientInputs['net_npa_diff'] ?? '' }}"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        ...
                        या कालावधीचे कर लेखापरीक्षण श्री. <span style="background: #00ff00;"><input type="text" class="form-control d-inline-block" style="width:120px;display:inline;" name="tax_auditor_name" value="{{ $clientInputs['tax_auditor_name'] ?? '' }}"></span>
                        यांनी केले आहे. त्यासाठी संस्थेचे रु. <span style="background: #00ff00;"><input type="text" class="form-control d-inline-block" style="width:80px;display:inline;" name="tax_audit_fee" value="{{ $clientInputs['tax_audit_fee'] ?? '8000' }}"></span>
                        मानधन अदा केले आहे.
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        ...
                        .
                        <br>
                        संस्थेचे सन या कालावधीत चाचणी लेखापरीक्षण <span style="background: #00ff00;"><input type="text" class="form-control d-inline-block" style="width:120px;display:inline;" name="test_auditor_name" value="{{ $clientInputs['test_auditor_name'] ?? '' }}"></span>
                ...
                <div class="mt-4">
                    <div class="fw-bold mb-2">5. <span style="background: #00ff00;">कलम 89 (अ)(1) तपासणी</span> :</div>
                    <div class="ps-3">
                        ...
                        .
                        <br>
                        अशी तपासणी झाली असल्यास, संस्थेने त्या कालावधीत सहकार खात्याची कलम 89 (अ)(1) अन्वये हुद्दा यांनी तपासणी केली असून त्यांनी संस्थेस दि. <span style="background: #00ff00;"><input type="date" class="form-control d-inline-block" style="width:120px;display:inline;" name="section_89a1_report_date" value="{{ $clientInputs['section_89a1_report_date'] ?? '' }}"></span>
                ...
                <!-- 14) कलम 83/88 चौकशी -->
                <div class="mt-4">
                    <div class="fw-bold mb-2">6. <span style="background: #00ff00;">कलम 83/88 चौकशी</span> :</div>
                    <div class="ps-3">
                ...
                <div class="mt-4">
                    ...
                    <div class="ps-3">
                        ...
                        <select class="form-control d-inline-block" style="width:80px;display:inline;" name="any_training_held">
                            <option value="">Select</option>
                ...
                <div class="mt-4">
                    <div class="fw-bold mb-2">12) <span style="font-weight:bold;">संगणक प्रणाली व ITDP ऑडिट</span> :-</div>
                    <div class="ps-3">
                        अहवाल वर्षात संस्थेने ITDP ऑडिट केल्याची नोंद
                        <select class="form-control d-inline-block" style="width:80px;display:inline;" name="itdp_audit_done">
                            <option value="">Select</option>
                        ...
                        <ol class="mb-2" style="padding-left: 20px;">
                            <li>
                                ...
                                <select class="form-control d-inline-block" style="width:80px;display:inline;" name="fully_computerized">
                                    <option value="">Select</option>
                            ...
                            <li>
                                ...
                                <span style="background: #00ff00;">व्यवस्था पुरेशी आहे</span>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <span style="background: #00ff00;"><input type="text" class="form-control d-inline-block" style="width:200px;display:inline;" name="itdp_audit_firm" value="{{ $clientInputs['itdp_audit_firm'] ?? '' }}"></span>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="ps-3">
                        <table class="table table-bordered text-center align-middle" style="min-width:700px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>5</td>
                                    <td>अंतर्गत हिशोश तपासणीची नियुक्ती</td>
                                    <td>-</td>
                                    <td>-</td>
                                    <td>43 (6)</td>
                                </tr>
                                ...
                                <tr>
                                    <td>10</td>
                                    <td>नफा विनियोजन करणे व त्याचे संविभाजन करणे</td>
                                    <td>65</td>
                                    <td>50,51</td>
                                    <td>-</td>
                                </tr>
                ...
                <div class="mt-4">
                    <div class="fw-bold mb-2">14) <span style="font-weight:bold;">स्वनिधी व भागाचे नकद मूल्य</span> :- संस्थेचा स्वनिधी खालील प्रमाणे आहे.</div>
                    <div class="ps-3">
                        <table class="table table-bordered text-center align-middle" style="min-width:700px;">
                            <thead>
                                <tr>
